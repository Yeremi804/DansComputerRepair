    ...
    <div className="fixed bottom-6 right-6 z-[1000] flex flex-col items-end">
      ...
      {!isOpen && (
        <button
          ...
          className="h-14 w-14 flex items-center justify-center rounded-full bg-gradient-to-br from-sky-600 to-blue-700 text-white shadow-xl shadow-blue-500/30 transition-transform hover:scale-105 focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-500"
      ...
      {/* Chat panel — only rendered in DOM when open, so it never blocks other elements */}
      {isOpen && (
        <div className="w-[22rem] max-w-[calc(100vw-2rem)] overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-2xl shadow-slate-900/20">
